...
//
// NON ALZARE OLTRE: a 350k il system prompt va in overflow sui LLM locali
// e tutti i replacements escono a 0 senza errore visibile (silent fail).
// Provato 2026-05-28: 350k knowledge -> 0/241 replacements sia su Neo che
// su Morfeo. Tornati a 35k. Per MR molto lunghe (es. 187k Morfeo) usare
// il path Claude (auditor=claude) che ha cap 200k per sezione gestito da
// Anthropic con context 200k token nativo.
