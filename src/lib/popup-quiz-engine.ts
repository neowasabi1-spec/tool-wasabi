...
function parseProductImg(js: string): string {
...
function parseBetween(js: string, startMarker: string, endMarker: string): string {
...
function fillCfgFromInlineQuiz(js: string, cfg: Record<string, unknown>): void {
  if (!str(cfg.badge)) {
