...
const MQ_PACE_CSS = '#chatbox-content>.msg-row.bot:not(.mq-q){display:none!important}#chatbox-content>.msg-row.bot.mq-on{display:flex!important}#chatbox-content>label.yes-btn{display:none!important}#chatbox-content>label.yes-btn.mq-on{display:inline-block!important}#chatbox-content .mq-q.mq-on{display:flex!important}#chatbox-content label.option-btn.mq-on{display:block!important}#chatbox-content #quiz-loading.mq-on,#chatbox-content #quiz-results.mq-on{display:block!important}';
