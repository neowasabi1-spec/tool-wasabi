  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-6">
      <div className="max-w-md w-full bg-gray-900 border border-gray-800 rounded-2xl p-8 text-center">
        ...
        <h1 className="text-xl font-bold text-white mb-2">No access</h1>
        <p className="text-gray-400 text-sm mb-2">
          Your account <span className="text-white font-medium">{user?.email || 'current'}</span> does
          not yet have permissions to view this section.
        </p>
        <p className="text-gray-500 text-xs mb-6">
          Contact the workspace admin to enable the sections
          you need.
        </p>
        <button
