...
## Installazione (una volta, 4 clic)

1. Apri Chrome (o Edge) e vai su `chrome://extensions`
2. In alto a destra attiva **Modalità sviluppatore**
3. Clicca **Carica estensione non pacchettizzata**
4. Seleziona la cartella `extension` (questa cartella)

Fatto. Fissa l'icona "Wasabi Saver" sulla barra se vuoi.

## Come si usa

1. Apri il tuo tool Wasabi in una scheda e fai **login** (una volta sola:
...
- La prima volta, se l'estensione dice "not connected", apri/ricarica la scheda
  del tool (dove sei loggato) e riapri il popup: si collega da sola.
- Durante gli screenshot Chrome mostra una barra "…sta effettuando il debug":
  è normale e sparisce subito.
- Pagine `chrome://` o dello store non si possono catturare.
